...
import '../../../../domain/shared_preferences/helper.dart';
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return Container(
                  ...
                  height: Helper.mediaSize(context, 'height', 'no'),
                  child: Center(
                      child: Lottie.network(
                    'http://documentation.optimaprotech.com/map.json',
              ...
              return MultiProvider(
                ...
                child: Stack(children: [
                  Scaffold(
                    ...
                    appBar: AppBar(
                        key: appBarKey,
                        leading: widget.automaticallyImplyAppBarLeading ||
                        ...
                        titleSpacing: 0.0,
                        title: Text('Conform Delivery Location')),
